...
namespace _03Model.Controllers
{
    public class HomeController : Controller
    {
        ...
        public string ShowAryDesc()
        {
            ...
            //Linq查詢運算式寫法-1
            //var result= from s in score  //s為陣列的名稱(資料庫裡的欄位名稱)
        ...
        public string ShowAryAsc()
        {
            ...
            //Linq查詢運算式寫法
            //var result = from s in score  //s為陣列的名稱(資料庫裡的欄位名稱)
            //             orderby s ascending //ascending為預設，故可省略不寫
            //             select s;

            //Linq擴充方法的寫法
            var result = score.OrderBy(s => s);  //ascending為預設，故可省略不寫
        ...
        {
            //Member member = new Member();  //鑄造物件，需引入Name Space
            //member.UId = "tom";
            //member.Pwd = "123";
            //member.Name = "姆湯";
            ...
            {
                new Member{UId="tom",Pwd="123",Name="姆湯" },
